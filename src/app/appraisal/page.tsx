...
const PUBLISHED_ARTICLES = [
  ...
  {
    number: "002",
    title: "BRL-CAD — 米陸軍が40年間メンテし続けたCコードの考古学",
    url: null,
    language: "C",
    year: 1979,
  },
  ...
  {
    number: "007",
    title: "RPG 5250 顧客マスタ → Web変換（約15分で完了）",
    url: null,
  ...
  {
    number: "009",
    title: "C → Rust 変換 — 33万行を1万行に（97%削減、2日で完了）",
    url: null,
    language: "C → Rust",
    year: 2002,
  },
  {
    number: "010",
    title: "MUMPS VistA Problem List → Web変換",
    url: null,
  ...
  {
    number: "011",
    title: "Fortran 土星磁場モデル → 3Dインタラクティブ可視化",
    url: null,
  ...
  {
    number: "012",
    title: "DSPython — Nintendo DSの4MBにPythonを載せた話",
    url: null,
    language: "C / Python",
    year: 2007,
  },
